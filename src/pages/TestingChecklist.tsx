...
const initialCategories: TestCategory[] = [
  ...
  },
  {
    ...
    cases: [
      ...
      { id: "pg-2", description: "Load Path to Funding (/path-to-funding)", expected: "Page loads with all sections visible", status: "pending", notes: "" },
      { id: "pg-3", description: "Load Products (/path-to-funding/products)", expected: "Products page loads with fund cards", status: "pending", notes: "" },
      { id: "pg-4", description: "Load Market Segments (/path-to-funding/market-segments)", expected: "Market segments page loads with sector icons", status: "pending", notes: "" },
      { id: "pg-5", description: "Load Funding Process (/path-to-funding/process)", expected: "Process page loads with steps", status: "pending", notes: "" },
